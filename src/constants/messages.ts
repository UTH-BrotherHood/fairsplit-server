export const USER_MESSAGES = {
  ...
  INVALID_AVATAR_FILE_TYPE: 'Only image files (jpeg, jpg, png, gif, webp, heic) are allowed for avatar upload',
  INVALID_PRIVACY_SETTINGS_FORMAT: 'Invalid privacy settings format',
  INVALID_PROFILE_VISIBILITY: 'Invalid profile visibility value',
  INVALID_FRIEND_REQUESTS_SETTING: 'Invalid friend requests setting',
